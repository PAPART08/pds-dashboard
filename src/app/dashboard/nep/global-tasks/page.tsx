            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        <Link href="/dashboard/nep" className="p-1.5 hover:bg-gray-100 rounded-full transition-colors text-gray-500">
                            <ArrowLeft className="w-5 h-5" />
                        </Link>
                        <h1 className="text-2xl font-black tracking-tight text-gray-900 uppercase">NEP Global Task Management</h1>
                    </div>
                    <p className="text-sm text-gray-500 pl-9">
                        Centralized workflow for EPA (Early Procurement Activity) projects.
                    </p>
                </div>
