  ...
  return (
    <div className="space-y-6 animate-fade-in px-4 md:px-0 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight mb-1" style={{ color: 'var(--dpwh-green, #10b981)' }}>NEP Final Approval Queue</h1>
          <p className="text-[color:var(--text-muted)]">Oversight and official recommendation for EPA projects.</p>
        </div>
